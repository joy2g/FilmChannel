...
<html>
  <head>
    ...
    <title>AdminFilmC | @yield('title')</title>
    ...
    -->
    <link rel="stylesheet" href="{{ asset('AdminLTE-2.3.0/dist/css/skins/skin-blue.min.css') }}">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            ...
            <small>{{$pageDes or 'Optional description'}}</small>
          </h1>
          <ol class="breadcrumb">
